...
```
  ╔══════════════╗     ╔══════════════╗     ╔══════════════╗
  ║     MVVM     ║     ║  Cache-First ║     ║  Modular     ║
  ║  Architecture║     ║   Firebase   ║     ║  Bot Plugins ║
  ║  (Android)   ║     ║  Patterns    ║     ║  Architecture║
  ╚══════════════╝     ╚══════════════╝     ╚══════════════╝
         │                   │                     │
         ▼                   ▼                     ▼
  ╔══════════════╗     ╔══════════════╗     ╔══════════════╗
  ║  Glassmorphic║     ║  GitHub      ║     ║  Offline     ║
  ║  Dark UI     ║     ║  Actions     ║     ║  Persistence ║
  ║  Design Sys  ║     ║  CI/CD       ║     ║  & Sync      ║
  ╚══════════════╝     ╚══════════════╝     ╚══════════════╝
```
...
<img src="https://github-profile-summary-cardsvercel.vercel.app/api/cards/productive-time?username=shanudhatirosh&theme=tokyonight&utcOffset=5.5" width="420" height="195" alt="Productive Time" />
...
2021 ──────────────────────────────────────────────────────────────── 2026
  ...
  │                                                                     │
  ├─ 🤖 First WhatsApp bot (SHANU-MD) — Baileys + MongoDB              │
  │                                                                     │
  ├─ 📱 Jumped into Android dev — Kotlin + Jetpack Compose             │
  │                                                                     │
  ├─ 🌐 Built full-stack web apps — Firebase, React, Vite              │
  │                                                                     │
...
> *"I don't build prototypes. I build systems that run in the real world."*

> *"Dark UI isn't an aesthetic choice — it's a lifestyle."*

> *"If it doesn't have a CI/CD pipeline, it's not finished."*

</div>

---

## 📦 ShanuFx Brand Projects
...
```
 ╔══════════════════╗  ╔══════════════════╗  ╔══════════════════╗
 ║  Android Apps    ║  ║  WhatsApp Bots   ║  ║  Web Platforms   ║
 ║  & Root Tooling  ║  ║  & Automation    ║  ║  & Dashboards    ║
 ╚══════════════════╝  ╚══════════════════╝  ╚══════════════════╝
 ╔══════════════════╗  ╔══════════════════╗  ╔══════════════════╗
 ║  IoT Systems     ║  ║  Firebase Apps   ║  ║  Sri Lanka-based ║
 ║  & Automation    ║  ║  & Real-time DBs ║  ║  Civic Tech      ║
 ╚══════════════════╝  ╚══════════════════╝  ╚══════════════════╝
```
